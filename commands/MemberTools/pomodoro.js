...
module.exports.run = async (client, message, args) => {
    ...
    if (args[0] === 'on') {
        try {
            message.channel.send(`You are now in pomodoro, ${message.author}! You'll get pinged in the discord at the ends of your intervals. \n You can return to an available text channel to gain normal access to the server again.`);
        ...
        try {
            ...
            message.channel.send(`${pomRole.name} You are now unmuted, ${message.author}. You can always return here to enter study mode again.`);
        } catch {
...
module.exports.help = {
    name: 'pomodoro',
    aliases: ['pomo', 'tomato', 'studyinterval'],
