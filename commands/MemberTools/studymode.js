...
module.exports.run = async (client, message, args) => {
    ...
    if (args[0] === 'on') {
        try {
            message.channel.send(`You are now muted, ${message.author}. You can always return here to gain access to the server again.`);
        ...
        try {
            ...
            message.channel.send(`You are now unmuted, ${message.author}. You can always return here to enter study mode again.`);
        } catch {
